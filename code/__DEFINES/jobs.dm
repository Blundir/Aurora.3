...
#define SEEGSON_ROLES list(COMMAND_ROLES, COMMAND_SUPPORT_ROLES, EQUIPMENT_ROLES, OFF_DUTY_CREW_MEMBER_ROLE, ENGINEERING_ROLES)
#define ICC_ROLES list(CIVILIAN_ROLES, REPRESENTATIVE_ROLE, DIPLOMATIC_AIDE_ROLE, CONSULAR_ROLE)
#define MARSHAL_ROLES list(SECURITY_ROLES, REPRESENTATIVE_ROLE)
#define SOUTA_ROLES list(SERVICE_ROLES)
#define SPEARHEAD_ROLES list(SCIENCE_ROLES)
#define BIONATIONAL_ROLES list(SCIENCE_ROLES, MEDICAL_ROLES, REPRESENTATIVE_ROLE)
#define CHIGUSA_ROLES list(OPERATIONS_ROLES, CIVILIAN_ROLES)
#define INDEP_ROLES list(NON_CREW_CIVILIAN_ROLES, JOURNALIST_ROLE, CHAPLAIN_ROLE, OFF_DUTY_CREW_MEMBER_ROLE, JOURNALIST_ROLE, DIPLOMATIC_AIDE_ROLE)
