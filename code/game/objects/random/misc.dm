/obj/random/smokable
	...
	problist = list(
		...
		/obj/item/storage/box/fancy/cigarettes/ace = 2,
		/obj/item/storage/box/fancy/cigarettes/dromedaryco = 10,
		/obj/item/storage/box/fancy/cigarettes/cigar = 9,
		/obj/item/storage/box/fancy/cigarettes/koorlander = 10,
		/obj/item/storage/box/fancy/cigarettes/american_spirit = 10,
