/datum/game_mode/odyssey
	name = "Odyssey"
	round_description = "Continue the Falconhurst's odyssey throughout the Spur and partake in whatever goes wrong (or right) today."
	extended_round_description = "The CSCSS Falconhurst - being an exploration vessel - often finds itself in various situations, good or bad. Today could be a good day for you, \
