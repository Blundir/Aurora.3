/datum/ghostspawner/human/ert/qukala
	...
	welcome_message = "You are a soldier of the Nralakk Federation Qukala, assigned to respond to a distress call from the CSCSS Falconhurst."
...
/datum/ghostspawner/human/ert/qukala/medic
	...
	welcome_message = "You are a medical specialist of the Nralakk Federation Qukala, assigned to respond to a distress call from the CSCSS Falconhurst."
...
/datum/ghostspawner/human/ert/qukala/engineer
	...
	welcome_message = "You are an engineering specialist of the Nralakk Federation Qukala, assigned to respond to a distress call from the CSCSS Falconhurst."
...
/datum/ghostspawner/human/ert/qukala/heavy
	...
	welcome_message = "You are a heavy weapons specialist of the Nralakk Federation Qukala, assigned to respond to a distress call from the CSCSS Falconhurst."
...
/datum/ghostspawner/human/ert/qukala/officer
	...
	welcome_message = "You are an officer of the Nralakk Federation Qukala, assigned to respond to a distress call from the CSCSS Falconhurst."
