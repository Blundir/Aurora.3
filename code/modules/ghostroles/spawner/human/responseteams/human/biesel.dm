/datum/ghostspawner/human/ert/tcaf
	...
	mob_name_prefix = "Lgn. "
	welcome_message = "You are a soldier of the Tau Ceti Republican Fleet, assigned to respond to a distress call from the CSCSS Falconhurst."
...
/datum/ghostspawner/human/ert/tcaf/medic
	...
	welcome_message = "You are a medical specialist of the Tau Ceti Republican Fleet, assigned to respond to a distress call from the CSCSS Falconhurst."
...
/datum/ghostspawner/human/ert/tcaf/engi
	...
	welcome_message = "You are an engineering specialist of the Tau Ceti Republican Fleet, assigned to respond to a distress call from the CSCSS Falconhurst."
...
/datum/ghostspawner/human/ert/tcaf/officer
	...
	welcome_message = "You are the commanding officer of a Tau Ceti Republican Fleet squadron, assigned to respond to a distress call from the CSCSS Falconhurst."
