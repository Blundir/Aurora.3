/datum/map/sccv_horizon
	...
	shuttle_manifests = list(
		"CSCSS Canary" = list("color" = "blue", "icon" = "binoculars"),
		"CSCSS Intrepid" = list("color" = "blue", "icon" = "compass"),
		"CSCSS Spark" = list("color" = "brown", "icon" = "gem"),
		"CSCSS Quark" = list("color" = "purple", "icon" = "microscope"),
	)
