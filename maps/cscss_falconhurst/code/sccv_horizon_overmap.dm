...
/obj/effect/overmap/visitable/ship/sccv_horizon
	class = "CSCSS"
	designation = "Falconhurst"
	desc = "A line without compare, the Venator-series consists of one vessel so far: the CSCSS Falconhurst, the lead ship of its class. Designed to be an entirely self-sufficient general-purpose surveying ship and to carry multiple replacement crews simultaneously, the Venator is equipped with both a bluespace and a warp drive and two different engines. Defying typical cruiser dimensions, the Venator is home to a sizable residential deck below the operations deck of the ship, where the crew is housed. It also features weapon hardpoints in its prominent wing nacelles. This one's transponder identifies it, obviously, as the CSCSS Falconhurst."
	icon_state = "venator"
...
/obj/effect/overmap/visitable/ship/landable/intrepid
	...
	desc = "A standard-sized exploration shuttle manufactured by Hephaestus, the Pathfinder-class is commonly used by the corporations of the SCC. Featuring well-rounded facilities and equipment, the Pathfinder is excellent, albeit pricey, platform. This one's transponder identifies it as the CSCSS Intrepid."
	shuttle = "Intrepid"
	icon_state = "intrepid"
...
/obj/effect/overmap/visitable/ship/landable/quark
	...
	desc = "\
		...
		This one's transponder identifies it as the CSCSS Quark. \
	"
	shuttle = "Quark"
