/datum/ghostspawner/human/ee_crewman
	...
	desc = "Crew the Einstein Engines research (or more accurately, spy) ship. Collect intelligence on the CSCSS Falconhurst, all while maintaining plausible deniability. NOT AN ANTAGONIST! Do not act as such."
	tags = list("External")
...
/datum/ghostspawner/human/ee_research_officer
	...
	desc = "Command the Einstein Engines research (or more accurately, spy) ship. Collect intelligence on the CSCSS Falconhurst, all while maintaining plausible deniability. NOT AN ANTAGONIST! Do not act as such."
	tags = list("External")
