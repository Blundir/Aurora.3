/singleton/scenario/nuclear_silo
	...
	desc = "A small wooden village within a valley in an arctic environment, entirely unlabelled on starcharts. Scans indicate \
			there may be more under the surface. As the CSCSS Falconhurst is the closest vessel within range, it has been dispatched to make contact."
...
/singleton/scenario_announcements/nuclear_silo
	...
	horizon_unrestrict_landing_message = "CSCSS Falconhurst, an SCC scouting vessel detected a hitherto uncontacted community within a small arctic valley on an \
