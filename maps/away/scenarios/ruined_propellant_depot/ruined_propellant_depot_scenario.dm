/singleton/scenario/ruined_propellant_depot
	...
	desc = "\
		...
		CSCSS Falconhurst, the closest ship in this sector, was sent by CC to investigate. \
		"
...
/singleton/scenario_announcements/ruined_propellant_depot
	...
	horizon_unrestrict_landing_message = "\
		Greetings, CSCSS Falconhurst. A nearby propellant depot has launched a distress beacon, requesting help. \
